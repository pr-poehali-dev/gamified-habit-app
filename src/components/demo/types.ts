...
// Предметы по возрасту (год обучения ≈ возраст - 6)
export const SUBJECTS_BY_AGE: Record<string, string[]> = {
  "6-7":   ["Чтение", "Математика", "Рисование", "Музыка", "Физкультура", "Труд"],
  "8-9":   ["Чтение", "Математика", "Русский язык", "Окружающий мир", "Английский язык", "Музыка", "Рисование", "Физкультура", "Труд"],
  "10-11": ["Математика", "Русский язык", "Окружающий мир", "Английский язык", "Литература", "Музыка", "Рисование", "Физкультура", "Труд", "История"],
  "12-13": ["Математика", "Алгебра", "Геометрия", "Русский язык", "Литература", "Английский язык", "История", "География", "Биология", "Физика", "Химия", "Физкультура", "Технология", "Информатика"],
  "14+":   ["Математика", "Алгебра", "Геометрия", "Русский язык", "Литература", "Английский язык", "Второй иностранный", "История", "Обществознание", "География", "Биология", "Физика", "Химия", "Физкультура", "Технология", "Информатика", "ОБЖ"],
};

export function getSubjectsByAge(age: number): string[] {
  if (age <= 7)  return SUBJECTS_BY_AGE["6-7"];
  if (age <= 9)  return SUBJECTS_BY_AGE["8-9"];
  if (age <= 11) return SUBJECTS_BY_AGE["10-11"];
  if (age <= 13) return SUBJECTS_BY_AGE["12-13"];
  return SUBJECTS_BY_AGE["14+"];
}
